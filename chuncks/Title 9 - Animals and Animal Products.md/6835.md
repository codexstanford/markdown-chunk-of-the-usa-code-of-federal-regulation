...
(g) Labeling information required in §§ 381.413, 381.454, 381.456, 381.460, 381.461, 381.462, and 381.480, whose type size is not otherwise specified, is required to be in letters and/or numbers no less thaninch in height, except as permitted by § 381.500(d)(2).
