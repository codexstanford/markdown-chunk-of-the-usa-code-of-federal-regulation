...
(iv) Any reservation fee shall be forfeited if the importer or the importer's agent fails to present for entry, within 24 hours following the designated time of arrival the lot of swine for which the reservation was made:that a reservation fee shall not be forfeited if:
