...
(J)Feed storage areas in the medium security facility must be vermin-proof. Also, if the medium security facility has multiple lot-holding areas, then separate storage space for supplies and equipment must be provided for each lot-holding area.
