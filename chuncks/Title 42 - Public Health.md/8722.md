...
(f)The applicable hospital-specific cost per discharge is multiplied by the appropriate DRG weighting factor to determine the hospital-specific base payment amount (target amount) for a particular covered discharge.
