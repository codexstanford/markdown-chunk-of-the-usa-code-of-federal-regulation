...
(e)After filing a hearing request in accordance with paragraphs (a) and (b), or paragraphs (c) and (d), of this section, a provider may add specific Medicare payment issues to the original hearing request by submitting a written request to the contractor hearing officer, only if-
