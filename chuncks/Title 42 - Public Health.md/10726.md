...
###### § 413.237 Outliers.
####### Pediatric predicted ESRD outlier services Medicare allowable payment (MAP) amount

(3)means the predicted per-treatment case-mix adjusted amount for ESRD outlier services furnished to a pediatric beneficiary by an ESRD facility.
