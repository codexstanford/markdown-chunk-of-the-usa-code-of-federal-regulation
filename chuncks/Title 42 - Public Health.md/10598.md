...
(3)means, with respect to a payment year, the 90th percentile of national ESRD facility performance on a clinical measure during the baseline period that applies to the measure for that payment year.
