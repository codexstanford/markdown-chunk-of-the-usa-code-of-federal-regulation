...
####### Canceled (voided) check

means an CHIP check issued by a State or fiscal agent that prior to its being cashed is canceled (voided) by the State or fiscal agent, thus preventing disbursement of funds.
