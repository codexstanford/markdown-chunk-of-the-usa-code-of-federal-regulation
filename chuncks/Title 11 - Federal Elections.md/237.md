...
(b)This exemption does not apply to funds received for activities indicating that an individual has decided to become a candidate for a particular office or for activities relevant to conducting a campaign. Examples of activities that indicate that an individual has decided to become a candidate include, but are not limited to:
