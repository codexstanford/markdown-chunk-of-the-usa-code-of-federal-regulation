...
###### Fixed Route System. Vehicle Capacity Over 16.

(b)If the entity operates a fixed route system and purchases or leases a vehicle with a seating capacity of over 16 passengers (including the driver) for use on the system, it shall ensure that the vehicle is readily accessible to and usable by individuals with disabilities, including individuals who use wheelchairs.
