...
(b)(1) The monetized value of the anticipated direct and indirect benefits to human health, safety, energy, and the air quality environment that are expected to result from implementation of the proposed project compared to:

(i) The existing environment with the transit system in the current year or,

(ii) At the discretion of the project sponsor, both the existing environment with the transit system in the current year and the no-build environment and transit system in the horizon year. The monetized benefits will be divided by the annualized federal share of the project.
