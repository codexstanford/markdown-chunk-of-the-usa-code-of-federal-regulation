...
(a) If a restroom is provided for the general public, and an accessible restroom is required by § 38.111 (a) and (e) of this part, it shall be designed so as to allow a person using a wheelchair or mobility aid to enter and use such restroom as specified in paragraphs (a) (1) through (5) of this section.
...
(b) Restrooms required to be accessible shall be in close proximity to at least one seating location for persons using mobility aids complying with § 38.125(d) of this part and shall be connected to such a space by an unobstructed path having a minimum width of 32 inches.
