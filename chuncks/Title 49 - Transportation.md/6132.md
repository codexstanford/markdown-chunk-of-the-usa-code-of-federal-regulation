...
(2) Specimens must conform to a gauge length of 8 inches with a width not over 1inches, a gauge length of 2 inches with width not over 1, or a gauge length at least 24 times thickness with a width not over 6 times thickness is authorized when a cylinder wall is not overinch thick.
