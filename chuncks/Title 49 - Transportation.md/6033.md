...
(2) Specimens for spheres must have a gauge length 2 inches with a width not over 1inches, or a gauge length at least 24 times the thickness with a width not over 6 times the thickness is authorized when a wall is not overinch thick.
...
(i) A gauge length of 8 inches with a width not over 1inches, or a gauge length of 2 inches with a width not over 1inches, or a gauge length at least 24 times the thickness with a width not over 6 times the thickness is authorized when a cylinder wall is not overinch thick.
