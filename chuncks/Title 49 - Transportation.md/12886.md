...
###### § 236.903 Definitions.
####### New or next-generation train control system

means a train control system using technologies not in use in revenue service at the time of PSP submission or without established histories of safe practice.
