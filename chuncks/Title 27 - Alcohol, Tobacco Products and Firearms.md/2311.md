...
(c)(1) The proprietor may not use an emergency method or procedure until the application has been approved by TTB except when the emergency method or procedure requires immediate implementation to correct a situation that threatens life or property. In a situation involving a threat to life or property, the proprietor may implement the corrective action while concurrently notifying the appropriate TTB officer by telephone of the action and filing the required written application. Use of the emergency method or procedure must conform to any conditions specified in the approval.
