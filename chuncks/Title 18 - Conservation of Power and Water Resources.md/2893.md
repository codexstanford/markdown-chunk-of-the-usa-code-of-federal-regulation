...
(f)means an energy input to the cogeneration facility used only in the thermal process of a topping-cycle cogeneration facility, or only in the electric generating process of a bottoming-cycle cogeneration facility;
