...
(7) Check the analyzer response using the span gas that has the minimum concentration of Oexpected during testing. Record the mean response of 30 seconds of stabilized sample data as.
