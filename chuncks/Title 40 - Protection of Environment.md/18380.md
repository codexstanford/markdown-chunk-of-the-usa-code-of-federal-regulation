...
(b) The owner or operator of any wet-process phosphoric acid plant shall maintain a daily record of equivalent POfeed by first determining the total mass rate in Mg/hr of phosphorus bearing feed using a monitoring device for measuring mass flowrate which meets the requirements of paragraph (a) of this section and then by proceeding according to § 60.204(b)(3).
