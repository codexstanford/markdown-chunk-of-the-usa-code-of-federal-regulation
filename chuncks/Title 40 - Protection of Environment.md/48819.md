...
(4) The unit's baseline NOemission rate under § 96.184(d);

(5) A statement whether the unit is to be allocated CAIR NOallowances § 96.188(b) or § 96.188(c) (subject to the conditions in §§ 96.184(h) and 96.186(g));

(6) A statement that the unit may withdraw from the CAIR NOAnnual Trading Program only in accordance with § 96.186; and
