...
(3)(i) In the event that an affected unit fails to meet an applicable standard, record the number of failures. For each failure record the date, time, and duration of each failure.
