...
(A)A parameter may be measured and recorded on an instantaneous basis (, the value that occurs at any time) and the operating limit specified as the time-weighted average during all runs of the compliance test; or
