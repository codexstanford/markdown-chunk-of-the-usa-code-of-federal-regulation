...
(r) For energy recovery units with annual average heat input rates greater than or equal to 250 MMBtu/hr and waste-burning kilns, you must install, calibrate, maintain, and operate a PM CPMS and record the output of the system as specified in paragraphs (r)(1) through (8) of this section. If you elect to use a particulate matter CEMS as specified in paragraph (n) of this section, you are not required to use a PM CPMS to monitor particulate matter emissions. For other energy recovery units, you may elect to use PM CPMS operated in accordance with this section. PM CPMS are suitable in lieu of using other CMS for monitoring PM compliance (bag leak detectors, ESP secondary power, PM scrubber pressure):
