...
(xiii)means an alternator where the ratio of the alternator output power to the power supplied to the alternator is greater than 67 percent, as measured using the Verband der Automobilindustrie (VDA) efficiency measurement methodology.
