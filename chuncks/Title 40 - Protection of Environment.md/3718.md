...
######## Glycol dehydration unit process vent emissions

means VOC-containing emissions from the glycol dehydration unit regenerator or still vent and the vent from the dehydration unit flash tank (if present).
