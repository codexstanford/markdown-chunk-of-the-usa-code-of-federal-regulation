...
(b)CNMI shall develop and submit an alternate operating permit program (the program) to EPA for approval. Upon approval by EPA, CNMI shall implement the program. The program, including the necessary statutory and regulatory authority, must be submitted by January 13, 1999 for approval. The submittal shall include the following elements:
