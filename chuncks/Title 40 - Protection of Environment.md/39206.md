...
(7)If an emission stream contains energetics or organic peroxides that, for safety reasons, cannot meet an applicable emission limit specified in this subpart, then you must submit an application to the Administrator explaining why an undue safety hazard would be created if the air emission controls were installed, and you must describe the procedures that you will implement to minimize HAP emissions from these vent streams in lieu of the emission limitations in this section.
