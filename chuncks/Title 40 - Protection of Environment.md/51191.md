...
(d)After making the deductions for compliance under paragraph (b) of this section for a control period in a year in which the Texas SOTrading Program source has excess emissions, the Administrator will deduct from the source's compliance account an amount of Texas SOTrading Program allowances, allocated for a control period in a prior year or the control period in the year of the excess emissions or in the immediately following year, equal to three times the number of tons of the source's excess emissions.
