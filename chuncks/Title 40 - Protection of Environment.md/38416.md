...
10.1.1.1Whenever the owner or operator makes a replacement, modification, or change in a certified continuous HCl or HF monitoring system that is used to provide data under this subpart (including a change in the automated data acquisition and handling system or the flue gas handling system) which affects information reported in the monitoring plan (e.g., a change to a serial number for a component of a monitoring system), the owner or operator shall update the monitoring plan.
