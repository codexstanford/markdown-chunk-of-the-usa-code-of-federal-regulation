...
means all possible complementary, cumulative distribution functions (CCDFs) that can be generated from all disposal system parameter values used in performance assessments.
