...
####### Redetermination of applicability to EPPUs that are flexible operation units.

(10)Whenever changes in production occur that could reasonably be expected to change the primary product of an EPPU that is operating as a flexible operation unit from an elastomer product to a product that would make the process unit subject to another subpart of this part, the owner or operator shall re-evaluate the status of the process unit as an EPPU in accordance with paragraphs (f)(10)(i) through (iii) of this section.
