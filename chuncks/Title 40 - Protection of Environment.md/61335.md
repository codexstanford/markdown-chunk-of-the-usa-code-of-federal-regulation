...
(a)Tolerances are established for residues of the fungicide dimethomorph, 4-[3-(4-chlorophenyl)-3-(3,4-dimethoxyphenyl)-1-oxo-2-propen-1-yl]morpholine, including its metabolites and degradates, in or on the commodities in the following table. Compliance with the tolerance levels specified in the following table is to be determined by measuring only dimethomorph in or on the commodities.
