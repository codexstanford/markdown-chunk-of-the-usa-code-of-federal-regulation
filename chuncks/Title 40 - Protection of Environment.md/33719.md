...
(c)If you are required to conduct a performance test, you must submit a notification of intent to conduct a performance test at least 60 calendar days before the performance test is scheduled to begin as required in § 63.7(b)(1). For any performance test required as part of the initial compliance procedures for batch process vents in table 2 to this subpart, you must also submit the test plan required by § 63.7(c) and the emission profile with the notification of the performance test.
