...
####### State-determined allocations of CSAPR SO,Group 2 allowances for 2016.

(g)A State listed in paragraph (c)(1) or (2) of this section may adopt and include in a SIP revision, and the Administrator will approve, as CSAPR SOGroup 2 allowance allocation provisions replacing the provisions in § 97.711(a) of this chapter with regard to the State and the control period in 2016, a list of CSAPR SOGroup 2 units and the amount of CSAPR SOGroup 2 allowances allocated to each unit on such list, provided that the list of units and allocations meets the following requirements:
...
(2) The total amount of CSAPR SOGroup 2 allowance allocations on the list must not exceed the amount, under § 97.710(a) of this chapter for the State and the control period in 2016, of the CSAPR SOGroup 2 trading budget minus the sum of the new unit set-aside and Indian country new unit set-aside;
