...
(ii) If a design analysis is used, then design documentation as specified in 40 CFR 264.1035(b)(4). The documentation shall include information prepared by the owner or operator or provided by the control device manufacturer or vendor that describes the control device design in accordance with 40 CFR 264.1035(b)(4)(iii) and certification by the owner or operator that the control equipment meets the applicable specifications.

(iii) If performance tests are used, then a performance test plan as specified in 40 CFR 264.1035(b)(3) and all test results.
