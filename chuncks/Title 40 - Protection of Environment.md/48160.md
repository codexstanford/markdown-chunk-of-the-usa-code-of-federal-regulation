...
######## active engine warm-up,Active engine warm-up

(B) Starting in model year 2023,means a system that uses waste heat from the vehicle's exhaust to warm up targeted parts of the engine so it reduces engine friction losses and enables closed-loop fuel control to start sooner.may also include coolant systems that capture heat from a liquid-cooled exhaust manifold.
