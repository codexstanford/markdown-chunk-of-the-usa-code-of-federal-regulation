...
(i) A letter signed by the owner's or operator's chief financial officer and worded as specified in § 264.151(g). If an owner or operator is using the financial test to demonstrate both assurance for closure or post-closure care, as specified by §§ 264.143(f), 264.145(f), 265.143(e), and 265.145(e),liability coverage, he must submit the letter specified in § 264.151(g) to cover both forms of financial responsibility; a separate letter as specified in § 264.151(f) is not required.
