...
(10) When more than one continuous automated sampling system is used to measure the emissions from one affected source (, multiple breechings, multiple outlets), the owner or operator shall report the results as required for each system.
