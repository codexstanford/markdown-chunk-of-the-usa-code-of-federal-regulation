...
(A) When testing diesel vehicles, the manufacturer shall allow a minimum of 20 minutes warm-up for the HC analyzer, and a minimum of 2 hours warm-up for the CO, COand NOanalyzers. [Power is normally left on for infrared and chemiluminescent analyzers. When not in use, the chopper motors of the infrared analyzers are turned off and the phototube high voltage supply to the chemiluminescent analyzers is placed in the standby position.]
