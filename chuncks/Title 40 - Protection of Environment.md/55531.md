...
7. Provost, L.P., and Elder, R.S. "Interpretation of Percent Recovery Data,"Laboratory, 15, 58-63 (1983). (The value 2.44 used in the equation in Section 8.3.3 is two times the value 1.22 derived in this report.)
...
12.4 Inject 2 to 5 µL of the sample extract or standard into the gas-chromatograph using the solvent-flush technique.Smaller (1.0 µL) volumes may be injected if automatic devices are employed. Record the volume injected to the nearest 0.05 µL, and the resulting peak size in area or peak height units.
