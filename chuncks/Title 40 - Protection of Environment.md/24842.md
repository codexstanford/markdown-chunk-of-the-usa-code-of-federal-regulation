...
(B) The continuous monitoring system fails a performance test audit (cylinder gas audit), relative accuracy audit, relative accuracy test audit or linearity test audit.
