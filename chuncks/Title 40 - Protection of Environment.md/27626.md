...
(f)Following the initial inspection and monitoring of a piece of air pollution control equipment in accordance with the applicable provisions of this section, subsequent inspection and monitoring of the equipment may be performed at intervals longer than 1 year when an owner or operator determines that performing the required inspection or monitoring procedures would expose a worker to dangerous, hazardous, or otherwise unsafe conditions and the owner or operator complies with the requirements specified in paragraphs (f)(1) and (f)(2) of this section.
