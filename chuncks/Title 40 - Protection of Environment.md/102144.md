...
(b)Once an engine is selected for testing (see § 1054.310), you may adjust, repair, prepare, or modify it or check its emissions only if one of the following is true:
