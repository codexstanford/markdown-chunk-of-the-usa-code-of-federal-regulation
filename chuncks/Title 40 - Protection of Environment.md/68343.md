...
() Identify a subset of relevant existing permit requirements, or develop alternative permit requirements, that ensure emissions of toxic compounds are minimized from startup, shutdown, and malfunction events, including releases from emergency safety vents, based on review of information including the source's startup, shutdown, and malfunction plan, design, and operating history.
