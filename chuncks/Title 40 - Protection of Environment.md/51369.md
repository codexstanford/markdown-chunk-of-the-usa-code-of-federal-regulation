...
(a)CSAPR NOOzone Season Group 3 allowances are available to be deducted for compliance with a source's CSAPR NOOzone Season Group 3 emissions limitation for a control period in a given year only if the CSAPR NOOzone Season Group 3 allowances:
