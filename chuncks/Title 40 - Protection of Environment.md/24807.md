...
(5) For an activated carbon injection system designed to control emissions of dioxins/furans, you are not required to establish an operating limit and monitor sorbent injection rate and carrier gas flow rate (or carrier gas pressure drop) if you use the continuous monitoring system specified in §§ 60.4865(b) and 60.4885(b) of this chapter to demonstrate compliance with the emission limit for dioxins/furans (total mass basis or toxic equivalency basis).
