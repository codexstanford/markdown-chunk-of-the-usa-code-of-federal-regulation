...
(2)If the 2-bag sampling method is used for the 75 &#xB0;F FTP test, it must be used to determine both city and highway fuel economy. The following calculations must be used to determine both city and highway fuel economy:
