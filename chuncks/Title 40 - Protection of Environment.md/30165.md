...
(v)In lieu of establishing mercury feedrate limits as specified in paragraphs (l)(1)(i) through (iv) of this section, you may request as part of the performance test plan under §§ 63.7(b) and (c) and §§ 63.1207 (e) and (f) to use the mercury feedrates and associated emission rates during the comprehensive performance test to extrapolate to higher allowable feedrate limits and emission rates. The extrapolation methodology will be reviewed and approved, as warranted, by the Administrator. The review will consider in particular whether:
