...
(6)A CSAPR NOOzone Season Group 1 allowance is a limited authorization to emit one ton of NOduring the control period in one year. Such authorization is limited in its use and duration as follows:

(i) Such authorization shall only be used in accordance with the CSAPR NOOzone Season Group 1 Trading Program; and
