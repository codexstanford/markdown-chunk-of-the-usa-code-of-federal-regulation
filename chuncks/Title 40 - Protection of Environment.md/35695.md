...
(3)You may use an alternative test method for determining the organic HAP weight fraction once the Administrator has approved it. You must follow the procedure in § 63.7(f) to submit an alternative test method for approval.
