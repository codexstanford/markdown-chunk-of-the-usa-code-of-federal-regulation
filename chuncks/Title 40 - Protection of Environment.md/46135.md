...
(C)The OBD system must detect a regeneration malfunction when the DPF does not properly regenerate under manufacturer-defined conditions where regeneration is designed to occur.
