...
All facilities must be equipped with the following,it can be demonstrated to the Regional Administrator that none of the hazards posed by waste handled at the facility could require a particular kind of equipment specified below:
