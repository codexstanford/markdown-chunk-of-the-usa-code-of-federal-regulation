...
######## Organic HAP emission rate based on coating solids applied.

(ix)Calculate the organic HAP emission rate based on coating solids applied using Equation 13 of this section.
