...
(ii) You may conduct a single root cause analysis and corrective action analysis for a single emergency event that causes two or more pressure relief devices to release, regardless of the equipment served, if the root cause is reasonably expected to be aevent, as defined in § 63.2550.
