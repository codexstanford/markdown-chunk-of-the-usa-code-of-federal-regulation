...
(ii)Requirements as specified in § 721.80(k) and (q). A significant new use is any use involving an application method that generates a vapor, mist or aerosol.
