...
means an incineration unit combusting sewage sludge for the purpose of reducing the volume of the sewage sludge by removing combustible matter. Sewage sludge incineration unit designs include fluidized bed and multiple hearth. AN SSI unit also includes, but is not limited to, the sewage sludge feed system, auxiliary fuel feed system, grate system, flue gas system, waste heat recovery equipment, if any, and bottom ash system. The SSI unit includes all ash handling systems connected to the bottom ash handling system. The combustion unit bottom ash system ends at the truck loading station or similar equipment that transfers the ash to final disposal. The SSI unit does not include air pollution control equipment or the stack.
