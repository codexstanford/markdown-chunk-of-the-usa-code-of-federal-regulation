...
() The minimum RPM must be set as 5 percent lower than the lowest 1-hour average RPM associated with each test run demonstrating compliance with the applicable emission limit.
