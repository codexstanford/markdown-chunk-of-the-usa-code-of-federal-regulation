...
(a)Texas SOTrading Program allowances are available to be deducted for compliance with a source's Texas SOTrading Program emissions limitation for a control period in a given year only if the Texas SOTrading Program allowances:
