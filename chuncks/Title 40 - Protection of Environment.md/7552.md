...
() The portion of the emissions budget under the State's emissions trading program regulations approved as a SIP revision under § 51.121 of this chapter that is attributable to the units to which applicability is expanded pursuant to paragraph (b)(12)(ii) of this section;

(B) Requires, to the extent the State adopts provisions for allocations or auctions of CSAPR NOOzone Season Group 3 allowances for any such control period to any CSAPR NOOzone Season Group 3 units covered by § 97.1011(a) of this chapter, that the State or the permitting authority submit such allocations or the results of such auctions for such control period (except allocations or results of auctions to such units of CSAPR NOOzone Season Group 3 allowances remaining in a set-aside after completion of the allocations or auctions for which the set-aside was created) to the Administrator by June 1 of the year before the year of such control period;
...
(iv) May adopt, in addition to the definitions in § 97.1002 of this chapter, one or more definitions that shall apply only to terms as used in the CSAPR NOOzone Season Group 3 allowance allocation or auction provisions adopted under paragraph (b)(12)(iii) of this section;
