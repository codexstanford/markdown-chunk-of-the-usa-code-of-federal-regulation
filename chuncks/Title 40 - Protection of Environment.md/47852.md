...
(1) Calculate a work factor,for each vehicle subconfiguration (or group of subconfigurations as allowed under paragraph (a)(4) of this section), rounded to the nearest pound, using the following equation:
