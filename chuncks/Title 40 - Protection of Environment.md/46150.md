...
####### Malfunction criteria for,sensors,Sensor performance.

(iv)NO-(A)The OBD system must detect a malfunction prior to any failure or deterioration of the sensor voltage, resistance, impedance, current, response rate, amplitude, offset, or other characteristic(s) that would cause an engine's emissions to exceed the emissions thresholds for NOsensors as shown in Table 1 of this paragraph (g).
