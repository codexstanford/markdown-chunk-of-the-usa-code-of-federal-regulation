...
(A) Through model year 2022,means a system that uses waste heat from the vehicle to quickly warm the transmission fluid to an operating temperature range using a heat exchanger, increasing the overall transmission efficiency by reducing parasitic losses associated with the transmission fluid, such as losses related to friction and fluid viscosity.
