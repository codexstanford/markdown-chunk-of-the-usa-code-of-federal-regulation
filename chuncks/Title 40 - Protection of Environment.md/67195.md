...
(b) The owner or operator of any drip pad that is inside or under a structure that provides protection from precipitation so that neither run-off nor run-on is generated is not subject to regulation under § 265.443(e) or § 265.443(f), as appropriate.
