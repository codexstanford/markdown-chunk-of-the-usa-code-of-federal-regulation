...
(1)If the 4-bag sampling method is used, manufacturers may use the equations in paragraphs (a) and (b) of this section to determine city and highway fuel economy estimates. If this method is chosen, it must be used to determine both city and highway fuel economy. Optionally, the following calculations may be used, provided that they are used to determine both city and highway fuel economy:
