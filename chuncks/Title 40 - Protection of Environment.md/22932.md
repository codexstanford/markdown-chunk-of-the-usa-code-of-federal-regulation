...
(A) Checking audit samples to confirm their true value as reported by the AASP.

(B) Performing technical systems audits of the AASP's facilities and operating procedures at least once every two years.

(C) Providing standards for use by the voluntary consensus standard body to approve the accrediting body that will accredit the audit sample providers.
