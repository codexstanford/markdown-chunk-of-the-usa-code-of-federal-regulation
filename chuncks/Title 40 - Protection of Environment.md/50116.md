...
means, for a CSAPR NOAnnual source and each CSAPR NOAnnual unit at the source, the natural person who is authorized by the owners and operators of the source and all such units at the source, in accordance with this subpart, to represent and legally bind each owner and operator in matters pertaining to the CSAPR NOAnnual Trading Program. If the CSAPR NOAnnual source is also subject to the Acid Rain Program, CSAPR NOOzone Season Group 1 Trading Program, CSAPR NOOzone Season Group 2 Trading Program, CSAPR NOOzone Season Group 3 Trading Program, CSAPR SOGroup 1 Trading Program, or CSAPR SOGroup 2 Trading Program, then this natural person shall be the same natural person as the designated representative as defined in the respective program.
