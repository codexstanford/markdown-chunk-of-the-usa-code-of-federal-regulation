...
(d)(1) EPA may determine that an antimicrobial pesticide product otherwise exempted by paragraph (c) of this section must be subject to the nonrefillable container regulations in this subpart to prevent an unreasonable adverse effect on the environment if all of the following conditions exist:
