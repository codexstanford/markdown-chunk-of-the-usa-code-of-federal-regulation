...
(a)CSAPR SOGroup 2 allowances are available to be deducted for compliance with a source's CSAPR SOGroup 2 emissions limitation for a control period in a given year only if the CSAPR SOGroup 2 allowances:
