...
(a)CSAPR NOAnnual allowances are available to be deducted for compliance with a source's CSAPR NOAnnual emissions limitation for a control period in a given year only if the CSAPR NOAnnual allowances:
