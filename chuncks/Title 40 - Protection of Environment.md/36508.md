...
The flow rate of the gas sample as it passes through the EC cell. In some situations, EC cells can experience drift with changes in flow rate. The flow rate must be monitored and documented during all phases of a sampling run.
