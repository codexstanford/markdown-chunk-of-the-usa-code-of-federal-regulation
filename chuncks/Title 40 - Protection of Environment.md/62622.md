...
means an alternative provision to the Compliance Criteria that only clarifies an existing regulatory provision, or does not substantively alter the existing regulatory requirements.
