...
(3) Monitor temperature of the landfill gas on a monthly basis as provided in 60.765(a)(5). The temperature measuring device must be calibrated annually using the procedure in 40 CFR part 60, appendix A-1, Method 2, section 10.3 such that a minimum of two temperature points, bracket within 10 percent of all landfill absolute temperature measurements or two fixed points of ice bath and boiling water, corrected for barometric pressure, are used.
