...
###### § 97.375 Petitions.
####### § 97.809 [Reserved]
######### Units incorrectly allocated CSAPR NO,Ozone Season Group 2 allowances.
...
(i)(A) The recipient is not actually a CSAPR NOOzone Season Group 2 unit under § 97.804 as of May 1, 2017 and is allocated CSAPR NOOzone Season Group 2 allowances for such control period or, in the case of an allocation under a provision of a SIP revision approved under § 52.38(b)(7), (8), or (9) of this chapter, the recipient is not actually a CSAPR NOOzone Season Group 2 unit as of May 1, 2017 and is allocated CSAPR NOOzone Season Group 2 allowances for such control period that the SIP revision provides should be allocated only to recipients that are CSAPR NOOzone Season Group 2 units as of May 1, 2017; or
...
(5)(i) With regard to the CSAPR NOOzone Season Group 2 allowances that are not recorded, or that are deducted as an incorrect allocation, in accordance with paragraphs (c)(2) and (3) of this section for a recipient under paragraph (c)(1)(i) of this section, the Administrator will:

(A) Transfer such CSAPR NOOzone Season Group 2 allowances to the new unit set-aside for such control period (or a subsequent control period) for the State from whose NOOzone Season Group 2 trading budget the CSAPR NOOzone Season Group 2 allowances were allocated; or

(B) If the State has a SIP revision approved under § 52.38(b)(8) or (9) of this chapter covering such control period, include such CSAPR NOOzone Season Group 2 allowances in the portion of the State NOOzone Season Group 2 trading budget that may be allocated for such control period (or a subsequent control period) in accordance with such SIP revision.
...
(A) Transfer such CSAPR NOOzone Season Group 2 allowances to the new unit set-aside for such control period (or a subsequent control period); or
