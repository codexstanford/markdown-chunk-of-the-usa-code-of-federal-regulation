...
(c) EPA will publish a notice in thewhich contains a list, accumulated for the previous month, of the sources for which complete base year emission data have been submitted and which are undergoing review either in the EPA Regional Office or a State agency within the EPA region. The notice will contain the name and location of each source and a contract in the EPA Regional Office for additional information.
