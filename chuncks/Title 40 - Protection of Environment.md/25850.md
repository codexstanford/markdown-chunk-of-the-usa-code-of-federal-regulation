...
(4)The TOC concentration (CG) is the sum of the concentrations of the individual components. If compliance is being determined based on TOC, the owner or operator shall compute TOC for each run using the following equation:
