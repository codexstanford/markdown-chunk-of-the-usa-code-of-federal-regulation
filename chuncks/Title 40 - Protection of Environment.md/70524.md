...
###### Calculation of drinking water threat score for a watershed.

4.2.2.4Multiply the drinking water threat factor category values for likelihood of release, waste characteristics, and targets for the watershed, and round the product to the nearest integer. Then divide by 82,500. Assign the resulting value, subject to a maximum of 100, as the drinking water threat score for the watershed. Enter this score in table 4-25.
