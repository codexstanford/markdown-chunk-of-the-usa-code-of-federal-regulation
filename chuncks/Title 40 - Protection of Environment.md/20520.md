...
(h) To demonstrate continuous compliance with the particulate matter emissions limit, a facility may substitute use of either a particulate matter CEMS or a particulate matter CPMS for conducting the particulate matter annual performance test. For units equipped with a particulate matter CEMS, you are not required to use other CMS monitoring for PM compliance (bag leak detectors, ESP secondary power, PM scrubber pressure). A facility may also substitute use of a particulate matter CEMS for conducting the PM initial performance test.
