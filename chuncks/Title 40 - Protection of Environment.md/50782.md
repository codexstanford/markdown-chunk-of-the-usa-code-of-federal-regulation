...
(6)A CSAPR SOGroup 2 allowance is a limited authorization to emit one ton of SOduring the control period in one year. Such authorization is limited in its use and duration as follows:

(i) Such authorization shall only be used in accordance with the CSAPR SOGroup 2 Trading Program; and
