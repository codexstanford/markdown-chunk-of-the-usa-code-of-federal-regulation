...
######## Changing from a group 1 controlled furnace processing other than clean charge to group 1 uncontrolled furnace processing other than clean charge

(a). An owner or operator wishing to change operating modes must conduct performance tests in accordance with §§ 63.1511 and 63.1512 to demonstrate to the permitting authority for major sources, or the Administrator for area sources that compliance can be achieved under both modes. Operating parameters relevant to each mode of operation must be established during the performance test.
