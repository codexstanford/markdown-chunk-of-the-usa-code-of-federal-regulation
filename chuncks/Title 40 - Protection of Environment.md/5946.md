...
(c)The test timer shall start (tt = 0) when the conditions specified in paragraph (I)(b)(2) of this appendix are met. The first-chance test shall have an overall maximum test time of 145 seconds (tt = 145). The first-chance test shall consist of an idle mode only.
