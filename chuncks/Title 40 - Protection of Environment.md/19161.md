...
####### Third-party,ertifier-based application process.

(f)c(1) Any manufacturer of an affected wood heater must apply to the Administrator for a certificate of compliance for each model line. The manufacturer must meet the following requirements:
