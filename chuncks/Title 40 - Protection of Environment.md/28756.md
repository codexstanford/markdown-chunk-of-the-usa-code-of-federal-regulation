...
() An emission testing interval shall consist of each 15-minute period during the performance test. For each interval, a reading from each measurement shall be recorded.
