...
means a motor vehicle which draws propulsion energy from onboard sources of stored energy that are both an internal combustion engine or heat engine using consumable fuel, and a rechargeable energy storage system such as a battery, capacitor, hydraulic accumulator, or flywheel. This includes plug-in hybrid electric vehicles.
