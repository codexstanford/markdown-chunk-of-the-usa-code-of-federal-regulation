...
(2)means a system in which the output of either compressor is controlled by cycling the compressor clutch off-and-on via an electronic signal, based on input from sensors (e.g., position or setpoint of interior temperature control, interior temperature, evaporator outlet air temperature, or refrigerant temperature) and air temperature at the outlet of the evaporator can be controlled to a level at 41 &#xB0;F, or higher.
