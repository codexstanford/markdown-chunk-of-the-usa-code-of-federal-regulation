...
(iii) Is from a device recovering only mechanical energy from a gas stream that comes either directly from any continuous operation, or from any continuous operation after passing solely (without passing through any other unit operation for a process purpose) through one or more recovery devices within the PVCPU.
