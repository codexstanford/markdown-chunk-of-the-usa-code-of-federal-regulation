...
(2) Do not enter negative inputs and confirm that negative emissions are not calculated. However, the decrease in SFinventory may be calculated as negative.

(3) Ensure that beginning-of-year inventory matches end-of-year inventory from the previous year.

(4) Ensure that in addition to SFpurchased from bulk gas distributors, SFreturned from equipment users with or inside equipment and SFreturned from off-site recycling are also accounted for among the total additions.
