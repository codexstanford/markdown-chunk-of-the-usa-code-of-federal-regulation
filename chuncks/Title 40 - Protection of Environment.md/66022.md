...
(b) If the remanufacturer or other person that stores or treats the hazardous secondary material installs a closed-vent system and control device to comply with the provisions of paragraph (a) of this section the closed-vent system and control device must meet the requirements of § 261.1033.
...
(d) When a remanufacturer or other person that stores or treats the hazardous secondary material and the Regional Administrator do not agree on determinations of vent emissions and/or emission reductions or total organic compound concentrations achieved by add-on control devices based on engineering calculations, the procedures in § 261.1034(c) shall be used to resolve the disagreement.
