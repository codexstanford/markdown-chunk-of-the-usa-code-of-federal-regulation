...
######## Blower motor controls which limit waste energy

(4)means a method of controlling fan and blower speeds which does not use resistive elements to decrease the voltage supplied to the motor.
