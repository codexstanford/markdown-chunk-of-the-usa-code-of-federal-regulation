...
15.2.2.3 Report a result for an analyte found in a sample or extract that has been diluted at the least dilute level at which the area at the quantitation m/z is within the calibration range (above the ML for the analyte) and the MS/MSD recovery and RPD are within their respective QC acceptance criteria (Table 6). This may require reporting results for some analytes from different analyses.
