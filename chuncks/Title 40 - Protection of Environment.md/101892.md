...
(b) Construct the following CumSum Equation for each engine family for HC, NO(HC + NO), and CO emissions:
...
(f) After each test, compare the current CumSum statistic, C, to the recalculated Action Limit, H, defined as H = 5.0 x &#x3C3;.
