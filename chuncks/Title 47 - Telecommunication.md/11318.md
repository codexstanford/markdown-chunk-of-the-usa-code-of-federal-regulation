...
(ii) They must use a Morse encoding of "PS" (dot-dash-dash-dot, dot-dot-dot), meaning "You should not come any closer". The width of a Morse dot is defined as equal to the width of a space andof the width of a Morse dash;
