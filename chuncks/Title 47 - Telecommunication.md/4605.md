...
(c) Each application for NGSO-like satellite operation that is acceptable for filing under § 25.112, except replacement applications described in paragraph (b) of this section, will be reviewed to determine whether it is a "competing application,"filed in response to a public notice initiating a processing round, or a "lead application,"all other applications for NGSO-like satellite operation.
