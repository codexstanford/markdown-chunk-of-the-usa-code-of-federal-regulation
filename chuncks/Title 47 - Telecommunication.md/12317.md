...
(b) Each station or licensed system of communication shall normally have a control point, or control points, at which the control operator or operators are stationed and at or from which the licensee may exercise supervision and control over the authorized facilities, as required by the provisions of § 90.461.Control point requirements may vary from one system to another, depending upon the nature of the radio operation; the way and by whom the facilities are employed; and other factors, as set out in other rule sections under this subpart.
