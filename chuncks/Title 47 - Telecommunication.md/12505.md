...
() In lieu of providing the requirements of paragraph (a)(1)(ii)(A)() of this section, provide the financial showings and all other certifications required in §§ 90.713 (b), (c) and (d) to demonstrate its ability to construct and operate a nationwide system consisting of fixed and/or paging operations on a primary basis instead of, or in addition to, its land mobile operations.
