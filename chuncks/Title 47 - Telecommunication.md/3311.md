...
(f) For UWB devices where the frequency at which the highest radiated emission occurs, f, is above 960 MHz, there is a limit on the peak level of the emissions contained within a 50 MHz bandwidth centered on f. That limit is 0 dBm EIRP. It is acceptable to employ a different resolution bandwidth, and a correspondingly different peak emission limit, following the procedures described in § 15.521.
