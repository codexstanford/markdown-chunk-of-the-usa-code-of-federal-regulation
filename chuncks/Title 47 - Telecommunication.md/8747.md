...
(i) LAT1and LON1= the coordinates of the first reference point in degree-decimal format.

(ii) LAT2and LON2= the coordinates of the second reference point in degree-decimal format.

(iii) ML = the middle latitude in degree-decimal format.

(iv) KPD= the number of kilometers per degree of latitude at a given middle latitude.

(v) KPD= the number of kilometers per degree of longitude at a given middle latitude.
