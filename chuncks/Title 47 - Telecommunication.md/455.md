...
######## duces tecum,duces tecum,duces tecum.

(b) Requests for a subpenashall be submitted in writing, duly subscribed and verified, and shall specify with particularity the books, papers, and documents desired and the facts expected to be proved thereby. Where the subpenarequest is directed to a nonparty to the proceeding, the presiding officer may issue the same, upon request, without an accompanying subpena to enforce a notice to take depositions, provided for in paragraph (e) of this section, where it appears that the testimony of said person is not required in connection with the subpena
