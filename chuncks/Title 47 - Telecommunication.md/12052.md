...
(b)The following table indicates frequencies available for assignment to stations in the Radiolocation Service, together with the class of station(s) to which they are normally assigned, and the specific assignment limitations, which are explained in paragraph (c) of this section:
