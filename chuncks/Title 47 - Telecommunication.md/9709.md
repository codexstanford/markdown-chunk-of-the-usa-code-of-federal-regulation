...
(b)A Class A television station that chooses to air an ATSC 3.0 signal must simulcast the primary video programming stream of that signal in an ATSC 1.0 format. This requirement does not apply to any multicast streams aired on the ATSC 3.0 channel.
