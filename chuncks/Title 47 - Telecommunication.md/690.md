...
######## Private Wireless Services.,See

(b)(1) A licensee of, or an applicant for, a station in the Private Wireless Services may request STA not to exceed 180 days for operation of a new station or operation of a licensed station in a manner which is beyond the scope of that authorized by the existing license.§§ 1.933(d)(6) and 1.939. Where the applicant, seeking a waiver of the 180 day limit, requests STA to operate as a private mobile radio service provider for a period exceeding 180 days, evidence of frequency coordination is required. Requests for shorter periods do not require coordination and, if granted, will be authorized on a secondary, non-interference basis.
