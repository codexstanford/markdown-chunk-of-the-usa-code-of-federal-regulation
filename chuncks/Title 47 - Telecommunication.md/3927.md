...
(c)For paging stations transmitting on the VHF channels, the distance from the transmitting antenna to the service contour along each cardinal radial is calculated as follows:
