...
(1) LAT1and LON1are the coordinates of the first location in degree-decimal format.

(2) LAT2and LON2are the coordinates of the second location in degree-decimal format.

(3) ML is the mean geodetic latitude in degree-decimal format.

(4) KPDis the number of kilometers per degree of latitude at a given mean geodetic latitude.

(5) KPDis the number of kilometers per degree of longitude at a given mean geodetic latitude.
