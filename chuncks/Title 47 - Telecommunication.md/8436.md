...
(d) The Administrative Council for Terminal Attachments shall file with the Commission, within 180 days of publication of these rules in the, a detailed report of the structure of the database, including details of how the Administrative Council for Terminal Attachments will administer the database, the pertinent information to be included in the database, procedures for including compliance information in the database, and details regarding how the government and the public will access the information.
