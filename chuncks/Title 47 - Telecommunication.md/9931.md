...
(i)(1) Next Gen TV stations relocating their ATSC 1.0 simulcast signals (e.g., moving to a temporary host station's facilities, subsequently moving to a different host, or returning to its original facility) must provide notice to MVPDs that:
