...
(b)(1) Service brake tests shall be conducted on surface-operated equipment at underground mines when an MSHA inspector has reasonable cause to believe that the service brake system does not function as required, unless the mine operator removes the equipment from service for the appropriate repair;
