...
(a) The table in this paragraph (a) shows the fees that you must pay to BOEM for the services listed. The fees will be adjusted periodically according to the Implicit Price Deflator for Gross Domestic Product by publication of a document in theIf a significant adjustment is needed to arrive at the new actual cost for any reason other than inflation, then a proposed rule containing the new fees will be published in thefor comment.
