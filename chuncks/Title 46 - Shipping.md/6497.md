...
Survival craft launching and recovery arrangements, in addition to meeting the requirements in § 133.150, must meet the following requirements:
...
(c) Each fall must be long enough for the survival craft to reach the water with the OSV in its lightest seagoing condition, under unfavorable conditions of trim and with the OSV listed not less than 20 degrees either way.

(d) Each unguarded fall must not pass near any operating position of the winch, such as hand cranks, pay-out wheels, and brake levers.

(e) Each winch drum must be arranged so the fall wire winds onto the drum in a level wrap. A multiple drum winch must be arranged so that the falls wind off at the same rate when lowering, and onto the drums at the same rate when hoisting.
...
(1) S = 0.4 + (0.02 H), where S is the speed of lowering in meters per second, and H is the height in meters from the davit head to the waterline at the lightest seagoing condition.

(2) S = 79 + (1.2 H), where S is the speed of lowering in feet per minute, and H is the height in feet.
...
(1) The brakes must be capable of stopping the descent of the survival craft or rescue boat and holding it securely when loaded with its full complement of persons and equipment.
