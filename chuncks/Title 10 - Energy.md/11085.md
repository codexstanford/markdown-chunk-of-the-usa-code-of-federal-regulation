...
6.1.4. The supply water temperature (T) (or inlet water temperature (T) if a recirculating loop is used) must be maintained within +/- 0.50 &#xB0;F of the initial reading at the start of the steady-state verification period.
