...
3.7.During the standby loss test, follow the data recording intervals specified in Table 3.1 of this appendix. Also, the electricity consumption over the course of the entire test must be measured and used in calculation of standby loss.
