...
5.3.5.Calculate the standby loss, expressed as a percentage (per hour) of the heat content of the stored water above room temperature, using the following equation:
