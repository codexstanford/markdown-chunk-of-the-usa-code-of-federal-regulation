...
(5) After the effective date of a rescission, any basic model(s) previously subject to a waiver must be tested and certified using the applicable DOE test procedure in 10 CFR part 431.
