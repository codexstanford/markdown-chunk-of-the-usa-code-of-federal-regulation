...
3.6Connect the clothes dryer to a watt meter as specified in section 2.4.7 of this appendix. Establish the testing conditions set forth in section 2 of this appendix.
...
3.6.3 Once the stable inactive/off mode state has been reached, measure and record the default inactive/off mode power, P, in watts, following the test procedure for the sampling method specified in Section 5, Paragraph 5.3.2 of IEC 62301.
