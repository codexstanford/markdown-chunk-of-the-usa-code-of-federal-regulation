...
(1)Any represented value of the SEER2, HSPF2, or other measure of energy efficiency of an individual model/combination for which consumers would favor higher values must be less than or equal to the output of the AEDM but no less than the standard.
