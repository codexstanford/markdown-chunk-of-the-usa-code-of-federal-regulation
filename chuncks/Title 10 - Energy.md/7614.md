...
(A)All representations for basic models of VRF multi-split systems must be based on the least-efficient outdoor unit model(s) distributed in commerce within the basic model.
