...
(i)DOE will obtain one or more units for test from retail, if available. If units cannot be obtained from retail, DOE will request that a unit be provided by the manufacturer;
