...
5.2.For water heaters that will experience cut-in based on a temperature-activated control that is internal to the water heater, use the following steps to conduct the standby loss test.
