...
####### Alternative efficiency determination method (AEDM) for walk-in refrigeration equipment,Criteria an AEDM must satisfy.

(f)-(1)A manufacturer may not apply an AEDM to a basic model to determine its efficiency pursuant to this section unless:
