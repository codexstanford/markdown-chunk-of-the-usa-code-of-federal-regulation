...
(f)The "Listing Citations and Applicable Rules" column is nonregulatory in nature and is provided for informational and navigational purposes only.

(1) Within the "Listing Citations and Applicable Rules" column, the following superscripts are used:

(2) Listing citations contain the volume, document starting page number, and publication date of thepublication(s) in which a species was given status, listed, or reclassified. At least since 1973, these documents have included a statement indicating the basis for the listing, as well as the effective date(s) of the listing or other rules that changed how the species was identified in the List in paragraph (h) of this section.
