...
(B) Prior to the initial start of the activity (when maneuvering on station), Navy personnel must observe the mitigation zone for marine mammals; if marine mammals are observed, Navy personnel must relocate or delay the start of firing.
