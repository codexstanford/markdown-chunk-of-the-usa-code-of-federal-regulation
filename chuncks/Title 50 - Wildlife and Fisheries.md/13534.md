...
####### Additional anchoring system and net panel weak link requirements.

(C)All gillnets must return to port with the vessel unless the gear meets the following specifications:
