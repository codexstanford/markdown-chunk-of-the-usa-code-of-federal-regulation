...
(ii)A limited access vessel operating under the DAS program and that end a fishing trip prior to setting and/or hauling fishing gear for any reason may request a cancelled trip DAS credit for the trip based on the following conditions and requirements.
