...
(b) For LOA modification or renewal requests by the applicant that include changes to the activity or to the mitigation, monitoring, or reporting measures (excluding changes made pursuant to the adaptive management provision in paragraph (c)(1) of this section) that do not change the findings made for the regulations in this subpart or result in no more than a minor change in the total estimated number of takes (or distribution by species or stock or years), NMFS may publish a notice of planned LOA in theincluding the associated analysis of the change, and solicit public comment before issuing the LOA.
