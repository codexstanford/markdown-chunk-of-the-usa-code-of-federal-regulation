...
(1)NMFS may modify (including augment) the existing mitigation, monitoring, or reporting measures (after consulting with Hilcorp or Eni regarding the practicability of the modifications) if doing so creates a reasonable likelihood of more effectively accomplishing the goals of the mitigation and monitoring set forth in the preamble for these regulations.
