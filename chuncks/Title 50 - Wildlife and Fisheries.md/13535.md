...
()All anchored gillnets, regardless of the number of net panels, must be secured at each end of the net string with a burying anchor (an anchor that holds to the ocean bottom through the use of a fluke, spade, plow, or pick) having the holding capacity equal to or greater than a 22-lb (10.0-kg) Danforth-style anchor unless exempted under paragraph (a)(5) of this section. Dead weights do not meet this requirement. A brochure illustrating the techniques for rigging anchoring systems is available from the Regional Administrator, NMFS, Greater Atlantic Region upon request.
