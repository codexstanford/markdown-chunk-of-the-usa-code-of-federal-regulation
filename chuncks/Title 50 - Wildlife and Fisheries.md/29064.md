...
c.A decreasing load test must be conducted with a test load approximately equal to one-half capacity when removing the test loads of an increasing load test.
