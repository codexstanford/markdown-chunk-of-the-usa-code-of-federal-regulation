...
(d)Commerce entities are not required to provide prior notice to an employee when the following adjustments are made by a Commerce entity to a Commerce employee's pay:
