...
######## Use of NOAA emblem (995.28).

(21)Value Added Distributor acknowledges that a separate request for the use of the NOAA emblem must be submitted according to the procedure described in this requirement.
