...
######## Distribution of data/compression (995.24(a)(1)(ii)).

(11)Distributor shall indicate if data compression techniques are used. If Distributor uses data compression techniques, Distributor asserts that the process meets the necessary regulations described by this requirement.
