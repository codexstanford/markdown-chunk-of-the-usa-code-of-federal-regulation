...
####### Reporting of liquidity stress tests required by home-country regulators.

(b)A foreign banking organization subject to this subpart must make available to the Board, in a timely manner, the results of any liquidity internal stress tests and establishment of liquidity buffers required by regulators in its home jurisdiction. The report required under this paragraph must include the results of its liquidity stress test and liquidity buffer, if required by the laws or regulations implemented in the home jurisdiction, or expected under supervisory guidance.
