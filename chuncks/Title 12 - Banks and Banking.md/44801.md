...
(10) The covered swap entity may not omit any risk factor from the calculation of its initial margin that the covered swap entity uses in its initial margin model unless it has first demonstrated to the satisfaction of FHFA that such omission is appropriate.

(11) The covered swap entity may not incorporate any proxy or approximation used to capture the risks of the covered swap entity's non-cleared swaps or non-cleared security-based swaps unless it has first demonstrated to the satisfaction of FHFA that such proxy or approximation is appropriate.
