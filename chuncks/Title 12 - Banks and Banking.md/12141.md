...
(v)A creditor may collect an application fee excludable from the finance charge under § 226.4(c)(1) before providing account-opening disclosures. However, if a consumer rejects the plan after receiving account-opening disclosures, the consumer must have no obligation to pay such an application fee, or if the fee was paid, it must be refunded.§ 226.5(b)(1)(iv)(A).
