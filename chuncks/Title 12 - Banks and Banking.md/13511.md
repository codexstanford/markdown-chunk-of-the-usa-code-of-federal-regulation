...
5.In some variable-rate plans, creditors may set an initial interest rate that is not determined by the index or formula used to make later interest rate adjustments. Typically, this initial rate is lower than the rate would be if it were calculated using the index or formula.
...
C. The other variable-rate information required by § 226.6(b)(4)(ii).
