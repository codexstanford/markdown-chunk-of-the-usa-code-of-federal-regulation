...
(5) When a maturity mismatch exists, the Enterprise must apply the following adjustment to reduce the effective notional amount of the credit risk mitigant: Pm = E x (t-0.25)/(T-0.25), where:
