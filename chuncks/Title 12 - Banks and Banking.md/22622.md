...
(3)With the prior written approval of the FDIC, an FDIC-supervised institution may estimate EAD for a netting set using a VaR model that meets the requirements in paragraph (b)(3)(iii) of this section. In such event, the FDIC-supervised institution must set EAD equal to max {0, [(ΣE-ΣC) + PFE]}, where:
