...
() The risk-based capital requirement for a direct exposure to the guarantor as calculated under § 3.131, using the PD for the protection provider, the LGD for the guarantee or credit derivative, and an EAD set equal to P.
