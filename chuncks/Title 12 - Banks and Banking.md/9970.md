...
(a)At least weekly, a Board-regulated institution must use the same internal model(s) used to calculate its VaR-based measure to calculate a stressed VaR-based measure.
