...
####### 1,Weighted average CAMELS rating score.,i

()() To compute the score for the weighted average CAMELS rating, a weighted average of an institution's CAMELS component ratings is calculated using the following weights:
