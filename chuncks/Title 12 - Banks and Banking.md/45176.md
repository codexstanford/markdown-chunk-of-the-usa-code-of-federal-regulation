...
(b)An ABCP conduit sponsor satisfies the risk retention requirement of § 1234.3 with respect to the issuance of ABCP by an eligible ABCP conduit in a securitization transaction if, for each ABS interest the ABCP conduit acquires from an intermediate SPV:
