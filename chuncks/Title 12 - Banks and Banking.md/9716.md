...
(B)= the EAD-weighted average of the effective maturity of each netting set with counterparty(where each netting set's effective maturity can be no less than one year.)
