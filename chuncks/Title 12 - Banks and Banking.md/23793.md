...
(d)When an NSFR liability of an FDIC-supervised institution is secured by an off-balance sheet asset or results from the FDIC-supervised institution selling an off-balance sheet asset (for instance, in the case of a short sale), other than an off-balance sheet asset received by the FDIC-supervised institution as variation margin under a derivative transaction:
