...
4.i. When the creditor has failed to take the action necessary to start the three-day rescission period running the right to rescind automatically lapses on the occurrence of the earliest of the following three events:
