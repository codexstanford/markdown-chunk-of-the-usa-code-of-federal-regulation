...
2.The following transactions, if structured as fixed-rate and not as adjustable-rate mortgages based on an index or formula, are not subject to § 1026.20(d):
