...
2.Section 226.18(c) establishes only a minimum standard for the material to be included in the itemization of the amount financed. Creditors have considerable flexibility in revising or supplementing the information listed in § 226.18(c) and shown in model form H-3, although no changes are required. The creditor may, for example, do one or more of the following:
