...
(b)Except as otherwise provided in a specific standard, in the case of a product manufactured in the United States, only the manufacturer must certify in accordance with, and provide the certificate required by, CPSA section 14(a) as applicable, that the product or shipment in question complies with all applicable CPSA rules and all similar rules, bans, standards, and regulations applicable to the product or shipment under any other Act enforced by the Commission.
