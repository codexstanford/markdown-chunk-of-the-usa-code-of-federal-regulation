...
(xiv)For any receiver decoder with a reset capability, the test must demonstrate that the reset will unlatch any command output that has been latched by a previous command.
