...
###### Electro-mechanical safe-and-arm devices with internal explosives.

(5)A safe-and-arm device must satisfy all its performance specifications when subjected to:
