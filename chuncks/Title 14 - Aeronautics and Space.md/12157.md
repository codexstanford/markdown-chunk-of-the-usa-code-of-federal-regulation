...
(a)A command receiver decoder must satisfy each test or analysis identified by any table of this section to demonstrate that the receiver decoder satisfies all its performance specifications when subjected to each non-operating and operating environment and any command control system transmitter variation.
