...
(2)Each all-fire voltage test must subject each exploding bridgewire sample to the manufacturer specified all-fire energy level for voltage, current, and pulse duration.
