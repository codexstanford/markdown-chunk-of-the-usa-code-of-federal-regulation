...
###### Altimetry system error containment: Group aircraft for which application for type certification is made after April 9, 1997.

(e)To approve group aircraft for which application for type certification is made after April 9, 1997, the Administrator must find that the altimetry system error (ASE) is contained as follows:
