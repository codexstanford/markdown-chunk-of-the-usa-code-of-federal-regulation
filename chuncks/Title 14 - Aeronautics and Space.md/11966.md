...
(ii) Debris subsonic ballistic coefficient (&#x3B2;). The difference between the smallest log(&#x3B2;) value and the largest log(&#x3B2;) value in a class must not exceed 0.5, except for fragments with &#x3B2;less than or equal to three. Fragments with &#x3B2;less than or equal to three may be grouped within a class.
