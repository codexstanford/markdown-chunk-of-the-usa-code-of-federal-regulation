...
(1) The name/business name, address/business address, and contact information (telephone number(s), email address(es), etc.) of the regulated person; the name/business name, address/business address, and contact information (telephone number(s), email address(es), etc.) of the purchaser;
