...
(i)VA will make a charge against entitlement for an overpayment only if the overpayment is discharged in bankruptcy, is waived and is not recovered, or is compromised.
