...
() The cumulative amount of revenue that is treated as taken into account as AFS revenue through the last day of 2022 ($10x per item) (or if the two amounts are equal, the equal amount).
