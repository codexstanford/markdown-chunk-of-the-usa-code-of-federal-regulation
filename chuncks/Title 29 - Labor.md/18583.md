...
(j)(1) When cleaning dust resulting from operations that cause, or can reasonably be expected to cause, airborne exposure above the TWA PEL or STEL, the employer must ensure the use of methods that minimize the likelihood and level of airborne exposure.
