...
(c)Prior to the assessment of any penalty under section 502(c)(2), the Department shall provide to the administrator of the plan a written notice indicating the Department's intent to assess a penalty under section 502(c)(2), the amount of such penalty, the period to which the penalty applies, and the reason(s) for the penalty.
