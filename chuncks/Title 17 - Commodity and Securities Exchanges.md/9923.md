...
####### Inter-affiliate exclusions.

(6)In connection with the definitions of "security-based swap dealer" and "major security-based swap participant," the report generally should consider the impact of rule provisions excluding inter-affiliate transactions from the relevant analyses, and should assess potential alternative approaches for such exclusions; and
