...
(7)A security-based swap dealer or major security-based swap participant must take prompt steps to liquidate positions in an account that does not meet the margin requirements of this section to the extent necessary to eliminate the margin deficiency.
