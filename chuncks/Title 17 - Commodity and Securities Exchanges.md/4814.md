...
(5) Evaluating whether the covered trading activities of trading desks that are engaged in permitted trading activity subject to § 75.4, 75.5, or 75.6(a) and (b) (underwriting and market making-related activity, risk-mitigating hedging, or trading in certain government obligations) are consistent with the requirement that such activity not result, directly or indirectly, in a material exposure to high-risk assets or high-risk trading strategies;
