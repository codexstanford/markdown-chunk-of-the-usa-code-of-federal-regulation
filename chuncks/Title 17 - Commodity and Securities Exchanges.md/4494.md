...
###### Compliance dates for interest rate swap classes.

(a)The compliance dates for swaps that are required to be cleared under § 50.4(a) are specified in the following table.
