...
(k)use means, with respect to the disclosure of a record, the use of a record for a purpose that is compatible with the purpose for which it was collected;
