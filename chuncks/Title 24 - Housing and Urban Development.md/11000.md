...
###### § 884.102 Definitions.
####### PHA-owner proposal and PHA-owner project.

A proposal for a project under this part (and the resulting project) to be owned by a PHA throughout the term of the Agreement and Contract where such Agreement and Contract are to be entered into between the PHA and HUD.
