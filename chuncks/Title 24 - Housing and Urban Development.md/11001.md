...
###### § 884.102 Definitions.
####### Private-owner/PHA proposal and private-owner/PHA project.

A proposal for a project under this part (and the resulting project) to be owned by a private Owner throughout the term of the Agreement and Contract where such Agreement and Contract are to be entered into between the private Owner and the PHA pursuant to an ACC between the PHA and HUD. The term also covers the situation where the ACC is with one PHA and the Owner is another PHA.
