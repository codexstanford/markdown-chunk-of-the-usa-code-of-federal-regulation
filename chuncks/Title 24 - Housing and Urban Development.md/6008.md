...
######### Partially-Funded LESA with no remaining funds.

(iv)(A) If the LESA is exhausted and the borrower fails to make property charge payments when due, the mortgagee shall use any funds available in the principal limit to pay the outstanding property charge amount in full and charge the borrower's account.
