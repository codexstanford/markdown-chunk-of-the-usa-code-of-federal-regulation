...
(b)An ABCP conduit sponsor satisfies the risk retention requirement of § 267.3 with respect to the issuance of ABCP by an eligible ABCP conduit in a securitization transaction if, for each ABS interest the ABCP conduit acquires from an intermediate SPV:

(1) An originator-seller of the intermediate SPV retains an economic interest in the credit risk of the assets collateralizing the ABS interest acquired by the eligible ABCP conduit in the amount and manner required under § 267.4 or § 267.5; and
