...
(b)HUD (or the PHA at the direction of HUD, as appropriate), after consultation with the Farmers Home Administration, may reduce the number of units covered by the Contract to the number of units available for occupancy by eligible families if:
