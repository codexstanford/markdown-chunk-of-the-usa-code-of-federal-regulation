...
(). In the case of a Private-Owner/PHA Project, a written agreement between HUD and the PHA to provide annual contributions to the PHA with respect to the project.
