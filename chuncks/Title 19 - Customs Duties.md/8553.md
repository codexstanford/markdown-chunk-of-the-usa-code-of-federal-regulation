...
(Following the itemslisted in the Parallel Columns, the applicant must make a statement affirming the same 8-digit HTSUS classification of the merchandise. This statement should be included in the application exactly as it is stated below:)
