...
(a)An importer who makes a claim under § 10.903(b) of this subpart based on a certification by the importer, exporter, or producer that the good is originating must submit, at the request of the Center director, a copy of the certification. The certification:
...
(i) The legal name, address, telephone, and email address (if any) of the importer of record of the good, the exporter of the good (if different from the producer), and the producer of the good;
...
(iv) The HTSUS tariff classification, to six or more digits, as necessary for the specific change in tariff classification rule for the good set forth in General Note 32(n), HTSUS; and

(v) The applicable rule of origin set forth in General Note 32, HTSUS, under which the good qualifies as an originating good; and
