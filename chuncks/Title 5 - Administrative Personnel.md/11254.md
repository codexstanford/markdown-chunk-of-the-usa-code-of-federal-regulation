...
(b)An employee may participate in any particular matter involving specific parties in which the disqualifying financial interest arises from the ownership by the employee, his spouse, or minor children of securities issued by one or more entities that are not parties to the matter but that are affected by the matter, if:
