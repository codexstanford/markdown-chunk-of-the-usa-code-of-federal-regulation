...
(h)means the date on which an application for an allotment is physically received by the BLM Alaska State Office, whether the application is delivered by hand, by mail, or by delivery service;
