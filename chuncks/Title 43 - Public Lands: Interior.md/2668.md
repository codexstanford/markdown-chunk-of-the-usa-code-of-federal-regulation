...
(b)Discovery may occur only as agreed to by the parties or as authorized by the ALJ during a prehearing conference or in a written order under § 45.40(g). The ALJ may authorize discovery only if the party requesting discovery demonstrates:
