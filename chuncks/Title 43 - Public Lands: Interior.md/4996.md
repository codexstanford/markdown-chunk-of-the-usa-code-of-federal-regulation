...
(c)This paragraph (c) applies unless you selected the scheduled rate adjustment method (see § 2806.51). If you hold a solar energy development lease, the MW capacity fee will be phased in, starting when electricity begins to be generated. The MW capacity fee for years 1-20 will be calculated using the MW rate in effect when the lease is issued. The MW capacity fee for years 21-30 will be calculated using the MW rate in effect in year 21 of the lease. These rates will be phased-in as follows:
