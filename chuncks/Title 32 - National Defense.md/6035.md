...
() The PHP shall assure that all certifications and information provided to the Director incident to the process of obtaining and retaining authorized provider status is accurate and that is has no material errors or omissions. In the case of any misrepresentations, whether by inaccurate information being provided or material facts withheld, authorized provider status will be denied or terminated, and the PHP will be ineligible for consideration for authorized provider status for a two year period.
