...
() The RTC shall assure that all certifications and information provided to the Director, incident to the process of obtaining and retaining authorized provider status is accurate and that it has no material errors or omissions. In the case of any misrepresentations, whether by inaccurate information being provided or material facts withheld, authorized status will be denied or terminated, and the RTC will be ineligible for consideration for authorized provider status for a two year period.
