...
(3) Elevation or floodproofing above the base flood elevation to meet State or local "freeboard" requirements,that a building must be elevated above the base flood elevation.
