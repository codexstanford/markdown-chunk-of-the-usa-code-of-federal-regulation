...
On or before the payment receipt date specified under § 1005.71, each handler shall pay to the market administrator itsshare of the expense of administration to the order at a rate specified by the market administrator that is no more than $.08 per hundredweight with respect to:
