...
(i) The amounts of any sale proceeds, FAS-provided funds, interest, program income, and voluntary committed cost sharing or matching contributions that the applicant proposes to use to fund:
...
(5) A project-level results framework that outlines the changes that the applicant expects to accomplish through the proposed project and is based on the McGovern-Dole Program-level results framework, as set forth in the notice of funding opportunity;
