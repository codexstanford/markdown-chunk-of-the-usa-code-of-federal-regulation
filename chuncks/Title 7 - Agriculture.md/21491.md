...
Multiple samples obtained from the same type of carriers (trucklots, containers) that are combined into one sample for grade to form a single lot inspection.
