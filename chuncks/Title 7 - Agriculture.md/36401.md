...
(ii) Water blocking elements must be compatible with the cable components when tested per paragraph 7.16,, of Part 7 of ICEA S-110-717 (incorporated by reference at § 1755.901(c)).
